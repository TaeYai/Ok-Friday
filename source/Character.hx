		...
		switch (curCharacter)
		{
			case 'gf':
				// GIRLFRIEND CODE
						...
						tex2 = Paths.getSparrowAtlas('preload/GF_assets');
				frames = tex;
			...
			case 'gfspeakers':
				// GIRLFRIEND CODE
				tex = Paths.getSparrowAtlas('preload/gfspeakers');
				frames = tex;
				animation.addByPrefix('cheer', 'GF Cheer', 24, false);
				animation.addByPrefix('singLEFT', 'GF left note', 24, false);
				animation.addByPrefix('singRIGHT', 'GF Right Note', 24, false);
			...
			case 'gfr':
				// GIRLFRIEND CODE
				tex = Paths.getSparrowAtlas('preload/GF_assets');
				frames = tex;
				animation.addByPrefix('cheer', 'GF Cheer', 24, false);
				animation.addByPrefix('singLEFT', 'GF left note', 24, false);
				animation.addByPrefix('singRIGHT', 'GF Right Note', 24, false);
			...
			case 'dad':
				...
				tex = Paths.getSparrowAtlas('preload/DADDY_DEAREST');
				frames = tex;
			...
			case 'bf':
				var tex = Paths.getSparrowAtlas('preload/BOYFRIEND');
				frames = tex;
			...
			case 'bfcar':
				var tex = Paths.getSparrowAtlas('preload/char');
				frames = tex;
				animation.addByPrefix('idle', 'BF idle dance', 24, false);
				animation.addByPrefix('singUP', 'BF NOTE UP0', 24, false);
				animation.addByPrefix('singLEFT', 'BF NOTE LEFT0', 24, false);
			...
			case 'bf-pixel':
				...
				flipX = true;
				case 'gfplay':
				var tex = Paths.getSparrowAtlas('preload/playableGF');
				frames = tex;
			...
			case 'parents-christmas':
				...
				case 'taeyai':
					tex = Paths.getSparrowAtlas('Taeyai');
					frames = tex;
				...
				case 'taeyai-evil':
					tex = Paths.getSparrowAtlas('Taeyai_fly');
					frames = tex;
